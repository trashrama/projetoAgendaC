...
struct st_pessoa{
    ...
    enum tipoEndereco{Alameda = 1, Avenida, Praça, Rua, Travessa}tipoEndereco;
...
void printarTpEndereco(int i){
    switch (agenda.contato[i].tipoEndereco){
    case Alameda:
        printf("Alameda");
        break;
    case Avenida:
...
void printarTpContato(int i){
    switch (agenda.contato[i].tipoContato){
    case Celular:
        printf("Celular");
        break;
    case Comercial:
...
void printarTpRede(int i){
    switch (agenda.contato[i].tipoRedeSocial){
    case Twitter:
        printf("Twitter");
        break;
    case Facebook:
...
void listarContatos(int total){
    if (total == 0){
        ...
        for (int c = 0; c < total; c++){
            ...
            printf("Endereço: "); 
            printarTpEndereco(c); 
            printf(" %s, nº %i\n", agenda.contato[c].endereco, agenda.contato[c].numCasa);
